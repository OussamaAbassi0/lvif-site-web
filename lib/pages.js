...
export const about = {
  ...
  team: {
    image: `${UPLOADS}/2025/11/EQUIPE-LVI.jpg`,
    alt: 'Équipe technique LED Visual Innovation devant un mur LED aux couleurs de la marque',
...
/**
 * Section « installation fixe » de la page d'accueil.
 * Reprend le bloc à deux onglets du site actuel, avec son bouton
 * « Calculer mon tarif » qui mène à la fiche produit correspondante.
 */
export const fixedInstall = {
  title: 'Écran géant LED pour installation fixe (achat)',
  lead: 'Cette catégorie regroupe à la fois des écrans géants destinés à une utilisation extérieure — également appelés panneaux LED extérieurs — et des écrans géants destinés à une utilisation intérieure, comme les murs d’images ou murs LED.',
  items: [
    {
      key: 'exterieur',
      label: 'En extérieur',
      title: 'En extérieur',
      body: [
        'Les installations fixes se regroupent principalement en deux catégories. Les enseignes numériques, apposées sur une façade de bâtiment professionnel ou fixées sur un mât acier — on parle alors d’enseigne déportée —, permettent à une entreprise de signaler son activité.',
        'Les écrans publicitaires extérieurs, également appelés panneaux LED publicitaires, sont en général installés sur poteaux acier. Ils sont utilisés par des agences de communication pour commercialiser des espaces publicitaires au profit de leurs clients.',
      ],
      image: `${UPLOADS}/2024/11/Garage_Gauthier___12m2___Bourg_de_Peage__28_-1233x1440.jpg`,
      alt: 'Écran géant LED de 12 m² installé en façade du Garage Gauthier à Bourg-de-Péage',
      tags: ['Garage Gauthier', 'Bourg-de-Péage', '2020'],
      cta: { label: 'Calculer mon tarif', href: '/catalogue/ecran-exterieur-led' },
    },
    {
      key: 'interieur',
      label: 'En intérieur',
      title: 'En intérieur',
      body: [
        'Les installations permanentes ont un usage varié. Les entreprises sont de plus en plus nombreuses à digitaliser leur communication interne, dans un environnement où les réunions à distance et les visioconférences sont quotidiennes. L’écran géant prend alors la forme d’un mur d’images, qui permet de communiquer avec les salariés comme avec les clients.',
        'Certains grands groupes en ont un usage spécifique : vidéosurveillance en salle de contrôle ou centre opérationnel, support de communication en salle de conférence et de réunion, ou encore fond de plateau pour les studios de tournage.',
      ],
      image: `${UPLOADS}/2026/06/ECRAN-LED-INCURVE-LVI-TOULOUSE-AIRBUS.webp`,
      alt: 'Écran LED incurvé installé en intérieur pour Airbus à Toulouse',
      tags: ['Airbus', 'Toulouse', '2026'],
      cta: { label: 'Calculer mon tarif', href: '/catalogue/ecran-interieur-led' },
    },
  ],
};
