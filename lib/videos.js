 ...
 * la remorque, les 24 h du Mans et le sol LED. Le reste des fichiers non
 * utilisés sont des doublons de format ou des rushes verticaux.
 *
...
/** Affiches : images déjà présentes dans la médiathèque du client. */
const POSTER = {
  autopolis: `${UP}/2024/12/AUTOPOLIS-PLACEHOLDER.webp`,
  bk: `${UP}/2024/12/BK-PLACEHOLDER.webp`,
  coque: `${UP}/2024/12/LA-COQUE-PLACEHOLDER.webp`,
  stade: `${UP}/2024/11/LVI-STADE-LUXEMBOURG-PLACEHOLDER.webp`,
};
 ...
 * Quatre onglets, comme sur le site actuel, avec les mêmes affiches.
 */
