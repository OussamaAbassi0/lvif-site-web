...
/* Avis clients — repris de la section « Nos avis clients vérifiés » du site */
export const reviews = {
  score: 5,
  count: 42,
  source: 'Avis soumis à un contrôle',
  items: [
    {
    ...
    {
      text: 'Un service de qualité, une équipe très professionnelle.',
      author: 'A. A.',
      date: '07/06/2024',
    },
    {
    ...
    {
      text: 'Excellent produit. J’ai été accompagné durant toute la durée du projet.',
      author: 'A. A.',
      date: '04/05/2024',
    },
  ],
